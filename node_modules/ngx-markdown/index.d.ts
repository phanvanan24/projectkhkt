...
declare function isSanitizeFunction(sanitize: SecurityContext | SanitizeFunction): sanitize is SanitizeFunction;
...
declare class MarkdownService {
    ...
    constructor(clipboardOptions: ClipboardOptions, extensions: MarkedExtension[], options: MarkedOptions, mermaidOptions: MermaidAPI.MermaidConfig, platform: Object, sanitize: SecurityContext | SanitizeFunction, http: HttpClient, sanitizer: DomSanitizer);
...
declare function isTypedProvider<T extends InjectionToken<any>>(provider: any): provider is TypedProvider<T>;
declare function getSanitizeProvider(sanitize: MarkdownModuleConfig['sanitize']): Provider | undefined;
/**
